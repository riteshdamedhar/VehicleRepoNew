<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_CarFeatures, App_Web_kbi1vbp0" %>
                ...
                <table width="100%" cellspacing="20">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:GridView ID="grd_feature" CssClass="grdfe" runat="server" AutoGenerateColumns="False" CellPadding="10"
                                ForeColor="#333333" GridLines="None" DataKeyNames="pkFeatureId" 
                                onrowcommand="grd_feature_RowCommand" HorizontalAlign="Center" 
                                ShowFooter="True" Width="30%">
                    ...
                    <center>
                        <table cellspacing="20">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_feature" MaxLength="20" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    <asp:Button ID="btn_save" CssClass="btnall" runat="server" Text="Add" 
                                        onclick="btn_save_Click" ValidationGroup="cspec" /><asp:Button
                                        ID="btn_cancel" CssClass="btnall" runat="server" Text="Cancel" 
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="Please Enter Car Feature" ControlToValidate="txt_feature" 
                            Display="None" ValidationGroup="cspec"></asp:RequiredFieldValidator>
